...
export default function SignUp() {
  ...
  const handleRegistrationSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    //registraciis logika
    // Call the onFinish function with form values
    onFinish({
      username: email, // Assuming email is used as username
      email: email,
      password1: password1,
      password2: password2,
      remember: false, // Adjust if needed
    });
  };
        ...
        <div className="register-main">
          <div className="register">
            ...
            <form onSubmit={handleRegistrationSubmit}>
              ...
              <div className="register-email-error-div">{!isEmailValid && formSubmitted && <span className="emailerror">Incorrect Email!</span>}</div>

              <div className="register-password-inputs">
                <div className="register-input-box">
                  <input type={showFirstPassword ? "text" : "password"} placeholder="Password" value={password1} onChange={handlePassword1Change} />
                  <img src={showFirstPassword ? passwordOpenImg : passwordImg} alt="" onClick={toggleFirstPasswordVisibility} className="password-toggle" />
                </div>

                <div className="register-input-box">
                  <input type={showSecondPassword ? "text" : "password"} placeholder="Repeat Password" value={password2} onChange={handlePassword2Change} />
                  <img src={showSecondPassword ? passwordOpenImg : passwordImg} alt="" onClick={toggleSecondPasswordVisibility} className="password-toggle" />
                </div>
              </div>
              ...
              <div className="passworderror-div">
                ...
                {!passwordsMatch && formSubmitted && password1 != "" && <span className="register-passworderror">Passwords do not match!</span>}
              </div>
              ...
              <button type="submit" className="btn" onClick={(event) => handleRegisterButtonClick("", event)}>
                Sign Up
              </button>
